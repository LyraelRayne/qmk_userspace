...
[ -d /workspaces/vial_splitkb ] || git clone https://github.com/splitkb/vial-qmk.git /workspaces/vial_splitkb
git config --global --add safe.directory /workspaces/qmk_firmware
git config --global --add safe.directory /workspaces/vial_splitkb

# qmk config user.qmk_home=/workspaces/qmk_firmware
qmk config user.qmk_home=/workspaces/vial_splitkb
